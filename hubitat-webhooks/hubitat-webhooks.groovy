/**
 * Hubitat webhooks
 * Author: Cam Soper (@camsoper - https://github.com/CamSoper)
 * URL: http://github.com/CamSoper/hubitat-camsoper/
 * 
 * A minor revision of the original app:
 * SmartThings webhooks
 *
 *  Original author: Harper Reed (@harper - harper@nata2.org)
...
//    def state_changed = evt.isStateChange()
    ...
    try {
		...
		httpPostJson(settings.url, json_body, { response ->
